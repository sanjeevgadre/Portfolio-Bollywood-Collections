...
plt.grid(axis = 'y')
plt.savefig('./figs/corr/feats/b_g_cond_y.jpg', dpi = 'figure')
plt.show()
...
plt.grid(axis = 'y')
plt.savefig('./figs/corr/feats/r_g_cond_y.jpg', dpi = 'figure')
plt.show()
...
plt.grid(axis = 'y')
plt.savefig('./figs/corr/feats/r_b_cond_y.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/corr//feats/w_g_cond_y.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.savefig('./figs/corr/feats/w_r_cond_b_y.jpg')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/corr/feats/s_g_cond_y.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/corr/feats/s_r_cond_b_y.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/corr/feats/s_b_cond_y.jpg', dpi = 'figure')
plt.show()
plt.close()

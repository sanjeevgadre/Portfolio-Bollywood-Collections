...
plt.grid(axis = 'y')
plt.savefig('./figs/03_RunLength/02_COR.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/03_RunLength/05_COR.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/03_RunLength/06_COR.jpg', dpi = 'figure')
plt.show()
plt.close()

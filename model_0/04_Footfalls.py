...
plt.grid(axis = 'y')
plt.savefig('./figs/04_Footfalls/02_COR.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/04_Footfalls/03_COR.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/04_Footfalls/06_COR.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/04_Footfalls/07_COR.jpg', dpi = 'figure')
plt.show()
plt.close()

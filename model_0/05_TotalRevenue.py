...
plt.grid(axis = 'y')
plt.savefig('./figs/05_TotalRevenue/02_COR.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/05_TotalRevenue/03_COR.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/05_TotalRevenue/04_COR.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/05_TotalRevenue/07_COR.jpg', dpi = 'figure')
plt.show()
plt.close()
...
plt.grid(axis = 'y')
plt.savefig('./figs/05_TotalRevenue/08_COR.jpg', dpi = 'figure')
plt.show()
plt.close()
